  ...
  return (
    <section id="events" className="relative min-h-screen w-full bg-[#0f0f11] text-white overflow-hidden border-b border-zinc-900 py-16 sm:py-24 flex flex-col items-center justify-center">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12 w-full relative z-10 my-auto flex flex-col items-center">
        ...
        <h2 className="font-display text-3xl sm:text-5xl font-extrabold tracking-tight uppercase text-white text-center mb-10 sm:mb-14">
        ...
        <div className="w-full max-w-[92%] sm:max-w-full mx-auto rounded-3xl bg-zinc-950 border border-zinc-800/90 overflow-hidden shadow-2xl transition-all duration-500 hover:border-zinc-700/80">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-0">
            ...
            {/* Event Info Drawer */}
            <div className="lg:col-span-5 p-8 sm:p-12 lg:p-14 flex flex-col justify-between items-center text-center bg-zinc-950 relative">

              {/* Centered Event Title & Specs Block */}
              <div className="my-auto py-6 w-full flex flex-col items-center justify-center text-center">
                <h3 className="font-display text-4xl sm:text-5xl lg:text-5xl font-black uppercase tracking-tight text-white leading-[0.95] text-center">
                  JUNIOR <br />
                  INDUCTION
                </h3>
                <div className="text-red-600 font-serif italic font-normal text-5xl sm:text-6xl lg:text-6xl mt-2 text-center drop-shadow-[0_0_15px_rgba(229,9,20,0.3)]">
                  2026
                </div>

                {/* Specs Section: 100% Centered Clean Lines */}
                <div className="w-full space-y-3 pt-6 font-mono text-xs text-zinc-300 flex flex-col items-center justify-center">
                  <div className="flex items-center justify-center gap-3 border-b border-zinc-900/90 pb-2.5 w-full max-w-xs text-center">
                  ...
                  <div className="flex items-center justify-center gap-3 border-b border-zinc-900/90 pb-2.5 w-full max-w-xs text-center">
                    ...
                    <span className="tracking-wider text-xs font-semibold text-zinc-200 truncate">VENUE: MAIN AUDITORIUM, NRCM</span>
                  </div>
                </div>
              </div>
